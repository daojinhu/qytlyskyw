// pages/deviceOrderManage/deviceOrderManage.js
var app = getApp()
Page({
  ...
  loadEndOrder: function(pageStart, pageSize) {
    ...
    //获取所有已结算订单信息---start
    wx.request({
      url: url + '/operUser/queryOperOrderByDeviceNameAndSettlement',
      data: {
  ...
  loadRechargeOrder: function(pageStart, pageSize) {
    ...
    //获取所有充值订单信息---start
    wx.request({
      url: url + '/operUser/queryOperOrderByDeviceNameAndPaymentMode',
      data: {
        deviceName: that.data.deviceName,
        paymentMode: 1,
        pageStart: pageStart,
